...
#print(labels_same)
#print(labels_diff)
#print(len(labels_same)+len(labels_diff))
#print(len(training_diff)+len(training_same))
...
#criterion = nn.TripletMarginLoss(margin = 0.2, distance=LpDistance(power=2))
...
new_name = "train_test_accuracies.pickle"
